...
import { Zap, SlidersHorizontal, Gift, Landmark, Download } from 'lucide-react'
...
const items = [
  ...
  { icon: Gift,             label: 'Reward Manager',    sub: 'Add & price rewards',             to: '/parent/rewards',  soon: false },
  { icon: Landmark,         label: 'Tax Fund',          sub: 'Family tax balance & spending',   to: '/parent/tax-fund', soon: false },
